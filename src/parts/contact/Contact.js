...
const Contact = () => {
    ...
    const handleMailClick = () =>{
        alert("Send a mail to: facundo.tabarez.0@gmail.com")
    };
  ...
  return (
    <section id="contact" className="">
      ...
      <div id="contact-sites-container">
        <a href="mailto:facundotabarez0@gmail.com" onClick={handleMailClick} title="facundotabarez0@gmail.com">
          <img
            id="mail"
        ...
        <a href="https://github.com/falsofacu" target="_blank" onClick={handleGithubClick} title="GitHub falsofacu">
          <img
            id="github"
            className="contact-icon"
            src={githubIcon}
        ...
        <a href="https://codepen.io/falsofacu/" target="_blank" onClick={handleCodepenClick} title="Codepen falsofacu">
          <img
            id="codepen"
            className="contact-icon"
            src={codepenIcon}
        ...
        <a href="https://www.freecodecamp.org/falsofacu" target="_blank" onClick={handleFccClick} title="freeCodeCap Certifications">
          <img
            id="fcc"
            className="contact-icon"
            src={fccIcon}
